...
private Bean bean;
	...
	private void createGetOptions() {
		...
		if (bean.selectionBehavior.selectionMode.equals(SelectionMode.DROPDOWN_OPTIONS)) {			
			...
			writeLine(" */");
			writeLine("@RequestMapping(value = {" + bean.serviceInterfaceName + ".GET_OPTIONS_URL}, method = RequestMethod.OPTIONS)");
		...
		if (bean.selectionBehavior.selectionMode.equals(SelectionMode.AUTO_COMPLETE)) {			
			...
			writeLine(" */");
			writeLine("@RequestMapping(value = {" + bean.serviceInterfaceName + ".SEARCH_OPTIONS_URL }, method = RequestMethod.OPTIONS)");
