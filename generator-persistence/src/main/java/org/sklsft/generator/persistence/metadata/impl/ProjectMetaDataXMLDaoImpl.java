...
import org.sklsft.generator.model.exception.InvalidProjectMetaDataException;
import org.sklsft.generator.model.exception.ProjectAlreadyConfiguredException;
...
public class ProjectMetaDataXMLDaoImpl implements ProjectMetaDataDao {
	...
	public void persistProjectMetaData(ProjectMetaData projectMetaData) {
		...
		try {
			...
			jaxbMarshaller.setProperty(Marshaller.JAXB_SCHEMA_LOCATION,"http://generator.sklsft.org/schema/model/metadata " + SCHEMA_LOCATION);
