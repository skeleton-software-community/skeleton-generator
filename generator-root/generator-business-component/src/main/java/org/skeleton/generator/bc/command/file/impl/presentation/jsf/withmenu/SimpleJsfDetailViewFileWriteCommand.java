...
public class SimpleJsfDetailViewFileWriteCommand extends JsfXhtmlFileWriteCommand {
	...
	public SimpleJsfDetailViewFileWriteCommand(Bean bean) {
	...
	protected void writeContent() throws IOException {
        ...
        {
            writeLine("<a4j:commandButton value=" + (char)34 + "#{i18n.update}" + (char)34 + " action=" + (char)34 + "#{" + bean.controllerObjectName + ".update" + bean.className + "AndRefresh}" + (char)34 + " rendered=" + (char)34 + "#{!" + bean.controllerObjectName + ".creationTag}" + (char)34 + " styleClass=" + (char)34 + "simpleButton" + (char)34 + " reRender=" + (char)34 + bean.objectName + "PanelGroup, " + bean.objectName + "DetailPanelGroup" + (char)34 + " oncomplete=" + (char)34 + "if (#{facesContext.maximumSeverity.ordinal==0}) Richfaces.hideModalPanel('" + bean.objectName + "ModalPanel')" + (char)34 + "/>");
        }
        writeLine("<a4j:commandButton value=" + (char)34 + "#{i18n.save}" + (char)34 + " action=" + (char)34 + "#{" + bean.controllerObjectName + ".save" + bean.className + "AndRefresh}" + (char)34 + " rendered=" + (char)34 + "#{" + bean.controllerObjectName + ".creationTag}" + (char)34 + " disabled=" + (char)34 + "#{!" + bean.controllerObjectName + ".creationTag}" + (char)34 + " styleClass=" + (char)34 + "simpleButton" + (char)34 + " reRender=" + (char)34 + bean.objectName + "PanelGroup, " + bean.objectName + "DetailPanelGroup" + (char)34 + " oncomplete=" + (char)34 + "if (#{facesContext.maximumSeverity.ordinal==0}) Richfaces.hideModalPanel('" + bean.objectName + "ModalPanel')" + (char)34 + "/>");
        writeLine("<a4j:commandButton value=" + (char)34 + "#{i18n.cancel}" + (char)34 + " action=" + (char)34 + "#{" + bean.controllerObjectName + ".refresh}" + (char)34 + " styleClass=" + (char)34 + "simpleButton" + (char)34 + " immediate=" + (char)34 + "true" + (char)34 + " reRender=" + (char)34 + bean.objectName + "PanelGroup" + (char)34 + " oncomplete=" + (char)34 + "Richfaces.hideModalPanel('" + bean.objectName + "ModalPanel')" + (char)34 + "/>");
        writeLine("</h:panelGrid>");
        skipLine();
