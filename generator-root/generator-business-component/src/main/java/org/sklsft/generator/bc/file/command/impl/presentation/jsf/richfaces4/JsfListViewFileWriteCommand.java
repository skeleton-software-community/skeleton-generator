...
public class JsfListViewFileWriteCommand extends JsfXhtmlFileWriteCommand {
	...
	protected void writeContent() throws IOException {
		...
		writeLine("<script>$(function(){hideCheck();});</script>");
		writeLine("</f:facet>");
		writeLine("<h:selectBooleanCheckbox rendered="+ CHAR_34 +"#{" + this.bean.objectName + ".canDelete}"+ CHAR_34 + " id=" + CHAR_34 + "selected" + CHAR_34 + " value=" + CHAR_34 + "#{" + this.bean.objectName + ".selected}" + CHAR_34 + " onclick=" + CHAR_34
		...
		if (this.bean.createEnabled) {
			...
			writeLine("<a4j:commandButton value=" + CHAR_34 + "#{i18n.create}" + CHAR_34 + " action=" + CHAR_34 + "#{" + this.bean.listControllerObjectName + ".create" + this.bean.className + "}"
					+ CHAR_34 + " styleClass=" + CHAR_34 + "btn btn-info" + CHAR_34 + " oncomplete=" + CHAR_34 + "if(#{" + bean.listViewObjectName + ".selected" + bean.className + " != null}) {$('#" + bean.objectName + "Modal').modal('show')}"
					+ CHAR_34 + " render=" + CHAR_34 + bean.objectName + "DetailPanelGroup" + CHAR_34 + "/>");
