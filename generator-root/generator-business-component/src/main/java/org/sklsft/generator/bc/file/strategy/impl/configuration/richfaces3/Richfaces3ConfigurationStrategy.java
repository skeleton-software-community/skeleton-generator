...
public class Richfaces3ConfigurationStrategy  implements LayerStrategy {
	...
	public FileWriteCommandTreeNode getLayerNode(Project project) {
		...
		FileWriteCommandTreeNode rootPomTreeNode = new FileWriteCommandTreeNode(new Richfaces3RootPomFileWriteCommand(project));
		...
		FileWriteCommandTreeNode webappPomTreeNode = new FileWriteCommandTreeNode(new Richfaces3WebappPomFileWriteCommand(project));
		...
		FileWriteCommandTreeNode springWebappTreeNode = new FileWriteCommandTreeNode(new Richfaces3SpringWebappFileWriteCommand(project));
