...
public class JsfListViewFileWriteCommand extends JsfXhtmlFileWriteCommand {
	...
	protected void writeContent() throws IOException {
		...
		writeLine("<rich:column>");		
		writeLine("<a4j:commandLink action=" + CHAR_34 + "#{" + bean.listControllerObjectName + ".reset" + bean.basicViewBean.filterClassName + "}" + CHAR_34 + " reRender=" + CHAR_34 + bean.objectName + "List, " + bean.objectName + "Scroller" + CHAR_34 + ">");
		...
		if (bean.deleteEnabled) {
			writeLine("<a4j:commandButton value=" + CHAR_34 + "#{i18n.deleteSelection}" + CHAR_34 + " action=" + CHAR_34 + "#{" + bean.listControllerObjectName + ".deleteList}" + CHAR_34
					+ " styleClass=" + CHAR_34 + "simpleButton" + CHAR_34);
			writeLine("onclick=" + CHAR_34 + "if (!confirm('#{i18n.confirmDeleteSelection}')) return false" + CHAR_34 + " reRender=" + CHAR_34 + bean.objectName + "PanelGroup"
					+ CHAR_34 + "/>");
		}
		writeLine("</h:panelGrid>");
		skipLine();
