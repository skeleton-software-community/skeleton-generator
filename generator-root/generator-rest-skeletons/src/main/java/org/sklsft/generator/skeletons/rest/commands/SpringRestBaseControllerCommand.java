...
private Bean bean;
	...
	private void createFindObject() {
		...
		write("@ResponseBody " + this.bean.fullViewBean.className + " find(");
	...
	private void createSaveOneToOneComponent() {
		for (OneToOneComponent oneToOneComponent : this.bean.oneToOneComponentList) {
			...
			writeLine("@ResponseBody public void save" + currentBean.className + "(@PathVariable(\"id\") Long id, @RequestBody " + currentBean.formBean.className + " form) {");
	...
	private void createDeleteObjectList() {
		...
		writeLine("@ResponseBody void deleteList(@RequestBody List<Long> idList) {");
	...
	private void createDeleteOneToManyComponentList() {
		for (OneToManyComponent oneToManyComponent : this.bean.oneToManyComponentList) {
			...
			writeLine("@ResponseBody void delete" + currentBean.className + "List(List<Long> idList) {");
