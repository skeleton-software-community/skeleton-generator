...
public class SpringRestProjectLocalPropertiesFileWriteCommand extends ProjectTemplatizedFileWriteCommand {

	public SpringRestProjectLocalPropertiesFileWriteCommand(Project project) {
