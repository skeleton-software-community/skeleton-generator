...
:PROMPT_SKL_TYPE
set /p SKELETON_NUMBER=Enter your skeleton type (1:SPRING_HIBERNATE_RICHFACES_3) : 
if %SKELETON_NUMBER% == 1 (set SKELETON_TYPE=SPRING_HIBERNATE_RICHFACES_3& goto PROMPT_SKL_TYPE_OK)
