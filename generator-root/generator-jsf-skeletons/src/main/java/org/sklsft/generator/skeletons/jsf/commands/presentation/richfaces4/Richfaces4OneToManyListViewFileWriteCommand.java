...
public class Richfaces4OneToManyListViewFileWriteCommand extends Richfaces4XhtmlFileWriteCommand {
	...
	protected void writeContent() throws IOException {
		...
		if (currentBean.detailMode.equals(DetailMode.PAGE)) {
			writeLine("<h:link outcome=\"/sections/" + currentBean.myPackage.urlPiece + "/" + currentBean.urlPiece + "/details.jsf\">");writeLine("<h:graphicImage url=\"/resources/images/icons/edit.png\" styleClass=\"imageIcon\" title=\"#{i18n.edit}\"/>");
